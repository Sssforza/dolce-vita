...
<main class="main page page_service">
    <section class="firstScreen firstSection_js">
        <div class="firstScreen__content">
                ...
                <div class="firstScreen__box">
                    <section class="breadCrumbs">
                        <ul class="breadCrumbs__list">
                            ...
                            <li class="breadCrumbs__item">
                                <span class="breadCrumbs__span">Лазерная эпияция LightSheer Duet</span>
                            </li>
                        </ul>
                    </section>
                    <div class="firstScreen__title">Лазерная эпияция LightSheer Duet</div>
                    <div class="firstScreen__text">
                        Лазерная эпиляция от&nbsp;бренда Lumenis дает максимальный результат, сохраняя комфорт клиента во&nbsp;время процедуры, даже в&nbsp;самых нежных и&nbsp;чувствительных зонах
                    </div>
                    <div class="firstScreenDepiction">
                        <div class="firstScreenDepiction__item">
                            <span class="firstScreenDepiction__span">от 15 минут</span>
                        </div>
            ...
            <div class="firstScreen__img" style="background-image:url(/dist/img/trash/firstScreen2.jpg)"></div>
        </div>
    </section>
    <section class="service">
        <div class="service__content">
            <section class="serviceAbout clientRect_js" id="procedure">
                <div class="serviceAbout__img serviceAbout__img_small serviceAbout__img_small_two" style="background-image:url(/dist/img/trash/serviceAbout__img_small2.jpg)"></div>
                <div class="serviceAbout__text">
                    <div class="service__title serviceAbout__title">Комфорт и&nbsp;максимум эффективности</div>
                    <div class="service__description serviceAbout__description">
                        <p>
                            Среди множества методов лазерной эпиляции доктора Dolce Vita, вслед за&nbsp;ведущими мировыми экспертами, предлагают аппарат LightSheer
                        </p>
                        <p>
                            Больше не&nbsp;нужно выбирать между комфортом и&nbsp;эффективностью, как в&nbsp;случае с&nbsp;другими технологиями.
                            Лазерная эпиляция LightSheer DUET дает максимальный результат, сохраняя комфорт клиента во&nbsp;время процедуры, даже
                            в&nbsp;самых нежных и&nbsp;чувствительных зонах
                        </p>
                    </div>
                </div>
                <div class="serviceAbout__img serviceAbout__img_middle" style="background-image:url(/dist/img/trash/serviceAbout__img_middle1.jpg)"></div>
                <div class="serviceSeo">
                        ...
                        <div class="serviceSeo__list">
                            <div class="serviceSeo__item">
                                ...
                                <div class="serviceSeo__box">
                                    <div class="serviceSeo__title">Быстро</div>
                                    <div class="serviceSeo__text">
                                        На&nbsp;сегодня в&nbsp;мире нет аналогов LightSheer DUET по&nbsp;скорости. Благодаря технологии
                                        вакуумного усиления и&nbsp;большой площади рукоятки процедуры стали комфортными и&nbsp;максимально
                                        быстрыми&nbsp;&mdash; время процедуры сократилось в&nbsp;3&nbsp;раза!
                                    </div>
                                </div>
                            </div>
                            <div class="serviceSeo__item">
                                ...
                                <div class="serviceSeo__box">
                                    <div class="serviceSeo__title">Безопасно</div>
                                    <div class="serviceSeo__text">
                                        Безопасность аппарата репутацией производителя&nbsp;&mdash; Lumenis (США, Израиль).
                                        Компания существует с&nbsp;1966&nbsp;года, специализируется на&nbsp;разработке и&nbsp;производстве
                                        медицинского оборудования, обладает 220 патентами
                                    </div>
                                </div>
                            </div>
                            <div class="serviceSeo__item">
                                ...
                                <div class="serviceSeo__box">
                                    <div class="serviceSeo__title">Стабильный результат</div>
                                    <div class="serviceSeo__text">
                                        Впечатляющий результат клиенты могут оценить уже после первой процедуры: волосы становятся реже,
                                        тоньше и&nbsp;светлее. Чтобы достичь постоянного эффекта, достаточно 6-8 процедур
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="servicePrice__box">
                        ...
                        <div class="servicePrice__present">
                            <div class="servicePrice__present_svg">
                                <?include $_SERVER['DOCUMENT_ROOT'] . '/dist/img/svg/gift.svg';?>
                            </div>
